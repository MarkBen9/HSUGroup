Explanation of codes used
	...
	Fits_Generator.py Runs all Epoch_MM_DD_YY_Normalization.py to create fits files: Epoch_MM_DD_YY.fits for all epochs. (as if must change number to select out particular epochs, should I change?)
	...
	Epoch_MM_DD_YY_Absorption.py- (cont._)
