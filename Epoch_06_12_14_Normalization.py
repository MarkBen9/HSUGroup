...
Data2 = fits.open("../Data/lcbx02010_x1dsum.fits")
#File says that the date obs was 6/12/14 16:51:31
Data1 = fits.open("../Data/lcbx02020_x1dsum.fits")
#File says that the date obs was 6/12/14 18:14:30
Data3 = fits.open("../Data/lcbx02030_x1dsum.fits")
#------------------------------------------------------------------------------
#Data Extraction
...
#For Grating 1
Normal_TFS1=[]
for i in range(0,find_index(TWL1,closest_value(TWL1,1162.7586))):                #First part, First order poly
    Normal_TFS1.append(TFS1[i]/(best_fit_poly_1[0]*(TWL1[i])+ best_fit_poly_1[1]))
for i in range(find_index(TWL1,closest_value(TWL1,1162.7586)),len(TWL1)):        #Second part, Second order poly
    Normal_TFS1.append(TFS1[i]/(best_fit_2ndpoly_1[0]*(TWL1[i])**2+ best_fit_2ndpoly_1[1]*(TWL1[i])+ best_fit_2ndpoly_1[2]))
#For Grating 2
Normal_TFS2=[]
for i in range(0,find_index(TWL2,closest_value(TWL2,1201.605217))):                #First part, second order polynomial
    Normal_TFS2.append(TFS2[i]/(best_fit_2ndpoly_2[0]*(TWL2[i])**2+ best_fit_2ndpoly_2[1]*(TWL2[i])+ best_fit_2ndpoly_2[2]))
for i in range(find_index(TWL2,closest_value(TWL2,1201.605217)),len(TWL2)):        #Second part, First order polynomial
